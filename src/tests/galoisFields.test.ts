...
describe('PrimeGaloisField class tests', () => {
    it('isContain method test', () => {
        let field = new PrimeGaloisField(2);
        let element = new FieldElement(1, field);
        let notContainElement = new FieldElement(5, field);

        expect(field.isContain(element)).toEqual(true);
        expect(field.isContain(notContainElement)).toEqual(false);
    });
});
...
describe('FieldElement class tests', () => {
    ...
    it('Closure test', () => {
        ...
        expect(field.isContain(element1)).toEqual(true);
        expect(field.isContain(element2)).toEqual(true);
        expect(field.isContain(element1.add(element2))).toEqual(true);
    });
